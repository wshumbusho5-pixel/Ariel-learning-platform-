      ...
      <div className="min-h-screen bg-white pb-24 lg:pl-[72px]">
        <div className="sticky top-0 z-40 bg-white border-b border-gray-100">
          <div className="max-w-2xl mx-auto px-4 h-14 flex items-center gap-3">
            ...
            <h1 className="text-[17px] font-bold text-zinc-900">Following</h1>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          {!loading && people.length === 0 && (
            <div className="py-24 text-center px-8">
              ...
              <p className="text-sm font-semibold text-zinc-700">Not following anyone yet</p>
              <p className="text-xs text-zinc-400 mt-1">Find people to follow from the search page.</p>
              <button
