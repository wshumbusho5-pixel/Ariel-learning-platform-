            ...
            <div className="space-y-4">
                ...
                {plan.blocks.map((block, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className={`w-2 h-2 rounded-full flex-shrink-0 ${isDone ? 'bg-emerald-400' : priorityDot(block.priority)}`} />
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                              <span className={`text-xs font-semibold px-2 py-0.5 rounded-full border ${isDone ? 'text-emerald-400 bg-emerald-900/20 border-emerald-800/40' : priorityColor(block.priority)}`}>
              ...
              {completedBlocks.size === plan.blocks.length && (
                <div className="bg-emerald-900/20 border border-emerald-700/40 rounded-xl p-5 text-center">
                  <p className="text-2xl font-bold text-emerald-400 mb-1">You're ready.</p>
                  <p className="text-sm text-emerald-300/70">Go get it.</p>
                </div>
              )}
            </div>
          )}
