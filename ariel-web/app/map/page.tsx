...
export default function KnowledgeMapPage() {
  ...
  const nodeColor = (pct: number) => {
    if (pct >= 80) return { ring: 'ring-violet-300', bg: 'bg-violet-900/30', text: 'text-violet-300', bar: 'bg-violet-400' };
    if (pct >= 50) return { ring: 'ring-violet-300', bg: 'bg-violet-900/20', text: 'text-violet-300', bar: 'bg-violet-400' };
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  { label: 'Mastered', value: totalMastered, color: 'text-violet-300' },
              ...
              <div className="flex items-center gap-4 text-xs text-zinc-500">
                {[
                  { label: '80%+ mastered', color: 'bg-violet-400' },
                  { label: '50–79%', color: 'bg-violet-400' },
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-violet-400 hover:bg-violet-300 text-white text-sm font-semibold rounded-lg transition-colors"
                        >
                          Review
                        </button>
                      </div>
