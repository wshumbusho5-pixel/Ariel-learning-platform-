    ...
    <div className="min-h-screen gradient-mesh pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        {rooms.length === 0 ? (
          <div className="text-center py-20">
            ...
            <button
              onClick={() => setShowCreateModal(true)}
              className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all hover:scale-105"
            >
            ...
            {rooms.map((room) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all hover:scale-105"
                >
                  Join Room
                </button>
              </div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="glass rounded-3xl p-8 max-w-md w-full shadow-2xl animate-scaleIn">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={createRoom}
                className="flex-1 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all hover:scale-105"
              >
                Create
              </button>
            </div>
