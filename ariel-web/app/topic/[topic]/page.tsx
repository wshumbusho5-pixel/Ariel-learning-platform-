      ...
      <div className="min-h-screen bg-[#09090b] lg:pl-[72px] pb-24">
        ...
        <header className="sticky top-0 z-30 bg-black/95 backdrop-blur border-b border-zinc-800">
          <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
            ...
            <button
              ...
              className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 bg-violet-400 hover:bg-violet-300 text-white text-xs font-bold rounded-full transition-colors"
            >
        ...
        <div className="max-w-2xl mx-auto px-4 py-5 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              onClick={() => router.push(createUrl)}
              className="flex items-center gap-3 p-4 bg-zinc-900 border border-zinc-800 hover:border-violet-300/50 hover:bg-violet-400/5 rounded-2xl transition-all text-left"
            >
              <div className="w-8 h-8 rounded-xl bg-violet-300/15 border border-violet-300/30 flex items-center justify-center flex-shrink-0">
                <svg className="w-4 h-4 text-violet-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
                </svg>
              </div>
              <div>
          ...
          <div>
            ...
            {loadingCards ? (
              ...
              <div className="text-center py-12 bg-zinc-900 border border-zinc-800 rounded-2xl">
                ...
                <button
                  onClick={() => router.push(createUrl)}
                  className="px-5 py-2.5 bg-violet-400 hover:bg-violet-300 text-white text-sm font-semibold rounded-xl transition-colors"
                >
                  ...
                  return (
                    <div key={card.id} className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden">
                        ...
                        {!isExpanded ? (
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex items-start gap-2">
                              <div className="w-4 h-4 rounded-full bg-violet-400 flex items-center justify-center flex-shrink-0 mt-0.5">
                      ...
                      <div className="px-5 pb-3 flex items-center gap-4 border-t border-zinc-800/60">
                        ...
                        >
                          <svg
                            className={`w-4 h-4 transition-colors ${isSaved ? 'text-violet-300' : 'text-zinc-600 group-hover:text-white'}`}
                          ...
                          <span className={`text-xs ${isSaved ? 'text-violet-300' : 'text-zinc-600'}`}>
                            {isSaved ? 'Saved' : 'Save'}
                          </span>
                        </button>
                      </div>
